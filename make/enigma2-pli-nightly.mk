...
$(D)/enigma2-pli-nightly.do_prepare:
	REVISION=""; \
	HEAD="master"; \
	DIFF="0"; \
	...
	echo " 7) Mon, 30 Dec 2013 18:33 - E2 OpenPli gstreamer / libplayer3 16cada2e02407c588382b95acc8f016ec4a29452"; \
	echo " 8) Sun, 23 Feb 2014 10:05 - E2 OpenPli gstreamer / libplayer3 16cada2e02407c588382b95acc8f016ec4a29452"; \
	echo " 9) Tue, 25 Mar 2014 18:17 - E2 OpenPli gstreamer / libplayer3 16cada2e02407c588382b95acc8f016ec4a29452"; \
	echo "========================================================================================================"; \
...
$(appsdir)/enigma2-pli-nightly/config.status: \
		...
		lxml libxmlccwrap libdreamdvd tuxtxt32bpp sdparm hotplug_e2 \
