...
#	remove the slink to busybox
	...
	cp -f $(targetprefix)/etc/init.d/swap $(prefix)/release_neutrino/etc/init.d/
...
release_neutrino_common_ipbox:
	...
	cp $(targetprefix)/boot/video_7109.elf $(prefix)/release_neutrino/lib/firmware/video.elf
	cp -dp $(buildprefix)/root/release/lircd_ipbox.conf $(prefix)/release_neutrino/etc/lircd.conf
...
release_neutrino_ufs910: release_neutrino_common_utils
	...
	cp -dp $(buildprefix)/root/release/lircd_ufs910.conf $(prefix)/release_neutrino/etc/lircd.conf
...
release_neutrino_spark: release_neutrino_common_utils
	...
	rm -f $(prefix)/release_neutrino/bin/vdstandby
	rm -f $(prefix)/release_neutrino/bin/eeprom
	cp -dp $(buildprefix)/root/release/lircd_spark.conf $(prefix)/release_neutrino/etc/lircd.conf
	cp -p $(targetprefix)/usr/sbin/lircd $(prefix)/release_neutrino/usr/bin/
...
release_neutrino_spark7162: release_neutrino_common_utils
	...
	rm -f $(prefix)/release_neutrino/bin/vdstandby
	rm -f $(prefix)/release_neutrino/bin/eeprom
	cp -dp $(buildprefix)/root/release/lircd_spark7162.conf $(prefix)/release_neutrino/etc/lircd.conf
	cp -p $(targetprefix)/usr/sbin/lircd $(prefix)/release_neutrino/usr/bin/
...
release_neutrino_hl101: release_neutrino_common_utils
	...
	cp $(targetprefix)/lib/firmware/dvb-fe-stv6306.fw $(prefix)/release_neutrino/lib/firmware/
	rm -f $(prefix)/release_neutrino/lib/firmware/dvb-fe-{avl6222,cx24116,cx21143}.fw
	cp -dp $(buildprefix)/root/release/lircd_hl101.conf $(prefix)/release_neutrino/etc/lircd.conf
	cp -p $(targetprefix)/usr/sbin/lircd $(prefix)/release_neutrino/usr/bin/
...
release_neutrino_adb_box: release_neutrino_common_utils
	...
	cp -dp $(buildprefix)/root/release/lircd_adb_box.conf $(prefix)/release_neutrino/etc/lircd.conf
...
release_neutrino_vip1_v2: release_neutrino_common_utils
	...
	cp -dp $(buildprefix)/root/release/lircd_vip1_v2.conf $(prefix)/release_neutrino/etc/lircd.conf
	cp -p $(targetprefix)/usr/sbin/lircd $(prefix)/release_neutrino/usr/bin/
...
release_neutrino_vip2_v1: release_neutrino_common_utils
	...
	rm -f $(prefix)/release_neutrino/lib/firmware/dvb-fe-{avl2108,avl6222,cx24116,cx21143,stv6306}.fw
	cp -f $(buildprefix)/root/release/fstab_vip2 $(prefix)/release_neutrino/etc/fstab
	cp -dp $(buildprefix)/root/release/lircd_vip2_v1.conf $(prefix)/release_neutrino/etc/lircd.conf
	cp -p $(targetprefix)/usr/sbin/lircd $(prefix)/release_neutrino/usr/bin/
...
release_neutrino_hs5101: release_neutrino_common_utils
	...
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/stgfb/stmfb/stmcore-display-stx7100.ko $(prefix)/release_neutrino/lib/modules/
	cp $(targetprefix)/boot/video_7100.elf $(prefix)/release_neutrino/lib/firmware/video.elf
	cp -dp $(buildprefix)/root/release/lircd_hs5vip2_v1.conf $(prefix)/release_neutrino/etc/lircd.conf
	cp -p $(targetprefix)/usr/sbin/lircd $(prefix)/release_neutrino/usr/bin/
...
release_neutrino_base:
	...
	$(INSTALL_DIR) $(prefix)/release_neutrino/lib/{modules,udev,firmware} && \
	...
	$(INSTALL_DIR) $(prefix)/release_neutrino/var/{bin,boot,etc,httpd,lib,tuxbox,update} && \
	...
	cp -dp $(buildprefix)/root/sbin/MAKEDEV $(prefix)/release_neutrino/sbin/MAKEDEV && \
	ln -sf ../sbin/MAKEDEV $(prefix)/release_neutrino/dev/MAKEDEV && \
	ln -sf ../../sbin/MAKEDEV $(prefix)/release_neutrino/lib/udev/MAKEDEV && \
	...
	cp -dp $(buildprefix)/root/etc/group $(prefix)/release_neutrino/etc/ && \
	...
	ln -sf /proc/mounts $(prefix)/release_neutrino/etc/mtab && \
	cp -dp $(buildprefix)/root/etc/passwd $(prefix)/release_neutrino/etc/ && \
...
if !ENABLE_UFS922
	...
	cp -dp $(buildprefix)/root/release/inittab$(if $(FORTIS_HDBOX)$(OCTAGON1008)$(CUBEREVO)$(CUBEREVO_MINI2)$(CUBEREVO_2000HD),_ttyAS1) $(prefix)/release_neutrino/etc/inittab
...
#
	...
	ln -s /var/tuxbox/plugins/libfx2.so $(prefix)/release_neutrino/lib/libfx2.so
...
#
	...
	cp -aR $(buildprefix)/root/root_neutrino/* $(prefix)/release_neutrino/
...
#
	if [ -d $(prefix)/release_neutrino/usr/lib/autofs ]; then \
		...
		cp -f $(buildprefix)/root/etc/auto.hotplug $(prefix)/release_neutrino/etc/; \
		cp -f $(buildprefix)/root/etc/auto.network $(prefix)/release_neutrino/etc/; \
		cp -f $(buildprefix)/root/etc/init.d/autofs $(prefix)/release_neutrino/etc/init.d/; \
...
#
	if [ -e $(targetprefix)/var/tuxbox/plugins/libfx2.so ]; then \
		cp -f $(targetprefix)/var/tuxbox/plugins/*.so $(prefix)/release_neutrino/var/tuxbox/plugins; \
		cp -f $(targetprefix)/var/tuxbox/plugins/*.cfg $(prefix)/release_neutrino/var/tuxbox/plugins; \
		cp -af $(targetprefix)/bin/{shellexec,msgbox,getrc,input} $(prefix)/release_neutrino/bin; \
	fi
	if [ -e $(prefix)/release_neutrino/var/tuxbox/plugins/tuxwetter.so ]; then \
		cp -rf $(targetprefix)/var/tuxbox/config/tuxwetter $(prefix)/release_neutrino/var/tuxbox/config; \
	fi
	if [ -e $(prefix)/release_neutrino/var/tuxbox/plugins/soko.so ]; then \
		cp -rf $(targetprefix)/usr/share/tuxbox/sokoban $(prefix)/release_neutrino/var/tuxbox/plugins; \
		ln -s /var/tuxbox/plugins/sokoban $(prefix)/release_neutrino/usr/share/tuxbox/sokoban; \
	fi

	if [ -e $(targetprefix)/var/tuxbox/plugins/tuxcom.so -a -e $(targetprefix)/var/tuxbox/plugins/tuxcom.cfg ]; then \
		cp -f $(targetprefix)/var/tuxbox/plugins/tuxcom* $(prefix)/release_neutrino/var/tuxbox/plugins; \
	fi
